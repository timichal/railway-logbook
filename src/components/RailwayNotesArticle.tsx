...
function CollapsibleSection({
  ...
  return (
    <div className="mb-4">
      ...
      {isOpen && <div className="ml-6 mb-8">{children}</div>}
    </div>
  );
}
    ...
    <div className="p-6">
      ...
      <div className="text-gray-700">
        <p className="mb-4">
          ...
          network as represented in this app. The general state of railway lines and timetabling is
          mentioned along with basic information about Interrail usage by country.
        </p>
        ...
        >
          <p className="mb-4">
            Czechia has a very dense railway network that has avoided large-scale closures, meaning
            trains run to many small towns and villages. Even low-demand lines are often served at
            least seasonally by scheduled tourist trains. Trains mostly run on a German-style{" "}
            <a
              href="https://en.wikipedia.org/wiki/Clock-face_scheduling"
              target="_blank"
              className="underline"
              rel="noopener"
            >
          ...
          <p className="mb-4">
            ...
            long-distance services are run by private operators, resulting in somewhat complicated
            operator- and region- based ticketing. However, tickets are comparatively cheap and{" "}
            <a
          ...
          <p className="mb-4">
            <a
              href="https://www.interrail.eu/en/plan-your-trip/tips-and-tricks/trains-europe/railway-companies"
              target="_blank"
              className="underline"
              rel="noopener"
            >
            ...
            with České dráhy and about half of private operators, the main exception being Arriva.
          </p>
          <p>
            Seat reservations are rarely necessary, except on the Praha-Ostrava route and some
            international trains. However, they are cheap and, especially on the busy main lines,
            useful.
          </p>
        </CollapsibleSection>
      </div>
