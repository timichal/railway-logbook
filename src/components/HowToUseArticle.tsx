  ...
  return (
    <div className="p-6">
      ...
      <div className="text-gray-700">
        ...
        <p className="mb-4">
          While in the <b>Route Logger</b> mode, you can either click on individual line parts or use the <b>Journey Planner</b> to find a route between two stations. You can then save the result as a journey - a basic unit of your log. Saved journeys are added to the <b>My Trips</b> tab where you can edit them or organize them into multi-journey trips.
        </p>
        <p className="mb-4">
